...
import { updateProperty, uploadPropertyImage } from "@/actions/properties";
...
export default function EditPropertyForm({ property }: EditPropertyFormProps) {
  ...
  const [latitude, setLatitude] = useState(property.latitude || 28.6139);
  const [longitude, setLongitude] = useState(property.longitude || 77.2090);
        ...
        <form action={handleSubmit} className="space-y-8">
            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                ...
                <div>
                  ...
                  <select
                    name="is_available"
                    defaultValue={String(property.is_available)}
          ...
          <section className="glass rounded-2xl p-6 animate-fade-in-up delay-150">
            ...
            <textarea
              ...
              defaultValue={property.neighborhood_info || ""}
              rows={3}
              className="input-field resize-none"
